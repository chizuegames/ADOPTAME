 ...
 *
 * Puntos exactos de transición solicitados:
 * - La práctica inicia con Valentina sobre IMGBE4.
 * - "Con esto termina el turno de Valentina..." ya pertenece al inicio del
 *   turno de Giovanni, por lo que desde ese diálogo usamos IMGBE1.
 ...
 * - Cuando la directora vuelve con
 *   "¡Hola de nuevo! Ya estoy de vuelta..." comienza su turno y usamos
 *   IMGBE3.
 */
...
function getPracticeTurnBackground(sceneIndexToCheck = sceneIndex) {
  ...
  const directoraStartIndex = findPracticeStepIndex("director-return");
